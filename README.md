...
|--------------------|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | **Braden Raid Garcia Cerpa:**<br> **Acciones AV1:** Participé en la organización del equipo, apoyando en la definición de ideas clave y asegurando que todos mantuvieran una misma línea de trabajo. Coordiné tareas y apoyé en la toma de decisiones.<br> **Acciones TB1:** Contribuí en la definición de funcionalidades del módulo de reportes y apoyé en la organización del equipo para el desarrollo de la propuesta de solución.<br> **Acciones AV2:** Lideré la implementación del bounded context de Savings (metas de ahorro y reportes mensuales) en el backend, coordinando con el equipo la integración de mis endpoints con los demás módulos.<br><br> **Hancco Poma, Keyner Ivan:**<br> **Acciones AV1:** Colaboré en reuniones grupales y en la ejecución de tareas asignadas. Aporté ideas para mejorar el enfoque del landing y mantener el avance del equipo.<br> **Acciones TB1:** Lideré la definición del dashboard analítico, proponiendo ideas para la visualización del consumo y asegurando coherencia en el diseño.<br> **Acciones AV2:** Lideré el desarrollo del bounded context de Property (edificios, unidades e inquilinos), articulando con los demás líderes la coherencia del modelo de dominio compartido del backend.<br><br> **Victor Manuel Espino Rossi:**<br> **Acciones AV1:** Contribuí en el diseño UX/UI y en la estructuración del contenido del landing. Apoyé en la coordinación del equipo y revisión de avances.<br> **Acciones TB1:** Participé en la definición de funcionalidades de perfil y notificaciones, apoyando en la experiencia de usuario y coherencia del sistema.<br> **Acciones AV2:** Lideré el bounded context de Consumption (sensores y lecturas de consumo), asegurando que su API se alineara con el dashboard y con el trabajo del resto del equipo.<br><br> **Hernan Gabriel Huayta Fuentes:**<br> **Acciones AV1:** Participé en la planificación de tareas y en la organización del contenido. Apoyé en la comunicación del equipo para mantener coherencia.<br> **Acciones TB1:** Definí aspectos del módulo de configuración, asegurando que las opciones de personalización estén alineadas con las necesidades del usuario.<br> **Acciones AV2:** Lideré el bounded context de Incident (detección y resolución de alertas), coordinando con Consumption para generar alertas a partir de las lecturas de consumo.<br><br> **Oscar Fernando Vara Velásquez:**<br> **Acciones AV1:** Colaboré en la definición de ideas y en la organización del trabajo. Participé activamente en las coordinaciones grupales.<br> **Acciones TB1:** Apoyé en la conceptualización del módulo de dispositivos, proponiendo ideas para su gestión dentro del sistema.<br> **Acciones AV2:** Lideré el esqueleto del proyecto y el bounded context de IAM (autenticación con JWT y roles), además de dirigir la integración del frontend con el backend, articulando el trabajo de todos los líderes en una versión unificada. | **Conclusión grupal AV1:**<br>El equipo logró mantener un liderazgo compartido, donde cada integrante aportó desde su rol para avanzar de manera coordinada. La comunicación constante y la organización de tareas permitieron un desarrollo ordenado del landing. Este enfoque facilitó la toma de decisiones y aseguró coherencia en el resultado final.<br><br> **Conclusión grupal TB1:**<br>El equipo mantuvo un liderazgo colaborativo, distribuyendo responsabilidades por módulos y asegurando una participación activa de todos los integrantes. La coordinación permitió avanzar de forma organizada en la definición de la solución y sentar bases claras para el desarrollo del sistema.<br><br> **Conclusión grupal AV2:**<br>El equipo consolidó un liderazgo compartido asignando a cada integrante un bounded context del backend, de modo que cada uno ejerció liderazgo técnico sobre su módulo mientras colaboraba en la integración. Esta distribución permitió construir la API REST de HydroSmart de forma coordinada y conectarla con el frontend, logrando una versión funcional de extremo a extremo. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | **Braden Raid Garcia Cerpa:**<br> **Acciones AV1:** Apoyé en la definición de objetivos y en la organización de tareas, asegurando claridad en las responsabilidades de cada integrante.<br> **Acciones TB1:** Participé en la planificación de tareas relacionadas a reportes y en la organización de actividades del equipo.<br> **Acciones AV2:** Definí las metas del módulo de ahorro y planifiqué las tareas para entregar los endpoints de metas de ahorro activas y reportes mensuales dentro del Sprint.<br><br> **Hancco Poma, Keyner Ivan:**<br> **Acciones AV1:** Participé en tareas asignadas y reuniones, manteniendo un ambiente colaborativo y cumpliendo con los objetivos.<br> **Acciones TB1:** Definí objetivos para el desarrollo del dashboard y coordiné tareas relacionadas al análisis de consumo.<br> **Acciones AV2:** Establecí los objetivos del módulo de propiedad y planifiqué las tareas de modelado de edificios/unidades y gestión de inquilinos, cumpliéndolas dentro del plazo del Sprint.<br><br> **Victor Manuel Espino Rossi:**<br> **Acciones AV1:** Establecí metas para el diseño UX/UI y planifiqué tareas del landing, asegurando el cumplimiento de objetivos.<br> **Acciones TB1:** Planifiqué tareas relacionadas a perfil y notificaciones, asegurando una experiencia de usuario coherente.<br> **Acciones AV2:** Planifiqué las tareas del módulo de consumo (modelo de dominio y endpoints de sensores y lecturas), cumpliendo el objetivo de persistencia real de los datos.<br><br> **Hernan Gabriel Huayta Fuentes:**<br> **Acciones AV1:** Colaboré en la planificación de actividades y mantuve comunicación constante para un avance ordenado.<br> **Acciones TB1:** Participé en la planificación del módulo de configuración y en la organización de tareas del equipo.<br> **Acciones AV2:** Definí las metas del módulo de incidentes y organicé las tareas de modelado y endpoints de alertas, asegurando su cumplimiento dentro del Sprint.<br><br> **Oscar Fernando Vara Velásquez:**<br> **Acciones AV1:** Participé en la organización del trabajo y en la planificación de tareas, contribuyendo al cumplimiento de metas.<br> **Acciones TB1:** Apoyé en la planificación de funcionalidades relacionadas a dispositivos y en la coordinación del trabajo grupal.<br> **Acciones AV2:** Establecí la meta de migrar a un backend real y seguro, planifiqué la estructura por bounded contexts y la estrategia de ramas, y coordiné la integración final para cumplir el objetivo del Sprint. | **Conclusión grupal AV1:**<br>Se logró un entorno colaborativo donde se definieron metas claras y se organizaron las tareas de manera eficiente. La participación activa permitió cumplir los objetivos establecidos, manteniendo un trabajo ordenado y alineado con lo requerido.<br><br> **Conclusión grupal TB1:**<br>El equipo logró establecer metas claras y distribuir tareas de acuerdo a los módulos del sistema. La planificación permitió cumplir los objetivos planteados y avanzar de manera organizada en la construcción de la propuesta de AquaPulse.<br><br> **Conclusión grupal AV2:**<br>El equipo estableció como meta principal reemplazar la simulación de datos por un backend real en Spring Boot conectado a MySQL. Se planificaron las tareas por bounded context y se trabajó con ramas independientes, cumpliendo los objetivos del Sprint y logrando una plataforma integrada con autenticación, persistencia y endpoints documentados. |
<div style="page-break-after: always;"></div>
...
<div align="center">
  <img src="images/impact mappings/Impact_Mapping_HydroSmartBG1.png" alt="Impact-Mapping-BG1" width="600">
</div>
...
<div align="center">
  <img src="images/impact mappings/Impact_Mapping_HydroSmartBG2.png" alt="Impact-Mapping-BG2" width="600">
</div>
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| **Link:** https://youtu.be/xy5I6LKYTCU                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                       |
| **Entrevista 2:** Kervy Ponce                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                                       |
| **Entrevistador:** Keyner Hancco                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                       |
| **Instante en el que inicia:**              0 minutos y 40 segundos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | **Duración:** 5 minutos y 20 segundos |
| **Imagen del entrevistado:**<br>![imagen_kervy](./images/Kervy-Entrevista.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |                                       |
| **Resumen de la entrevista:**<br>El entrevistado, Kervy Ponce, exploró junto al entrevistador el dashboard principal y otras secciones de la aplicación HydroSmart (AquaPulse). Respecto al dashboard, consideró que las cinco métricas principales (consumo mensual, porcentaje comparado al mes anterior, dispositivos activos, costo estimado de la próxima cuenta y consumo del día) son justas y precisas para tener un buen control del consumo. Sobre los gráficos centrales, sugirió como mejora que se pueda alternar la vista del consumo diario entre periodos semanales o mensuales, en lugar de mostrar únicamente los últimos 30 días de forma fija. En cuanto a las alertas activas, la meta de ahorro y la sección de dispositivos, su percepción fue positiva, destacando favorablemente la existencia de una pestaña de recomendaciones. Al revisar la sección de reportes, propuso que el dato del "día pico" de consumo se complemente mostrando junto a él la cantidad específica de agua consumida ese día. Sobre las opciones de exportación (PDF, Excel, CSV), las consideró adecuadas, sugiriendo opcionalmente añadir un formato de imagen. Finalmente, en la sección de perfil, sugirió incorporar la opción de cambiar la contraseña directamente desde esa pantalla, aunque se le aclaró que dicha función ya existe en el módulo de inicio de sesión (IAM). En general, calificó la aplicación con un 8 sobre 10, señalando que es bastante útil para el autocontrol del consumo, y que una mayor automatización podría hacerla aún más eficaz. |     

| Segmento objetivo #2: Administradores de Edificios                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                       |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| **Link:** https://youtu.be/7lp2Wb47sgQ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                       |
| **Entrevista 1:** Diego Galvez                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                       |
| **Entrevistador:** Braden García                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |                                       |
| **Sexo:** Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | **Edad**: 31                          |
| **Instante en el que inicia:**              0 minutos y 25 segundos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | **Duración:** 7 minutos y 25 segundos |
| **Imagen del entrevistado:**<br>![imagen_diego](./images/Diego-Entrevista.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                                       |
| **Resumen de la entrevista:**<br>El entrevistado, Diego Galvez, de 31 años, propietario de un edificio familiar con 5 departamentos en alquiler, exploró junto al entrevistador el funcionamiento de la aplicación HydroSmart desde un rol de administrador. Sobre el dashboard principal, su percepción fue positiva, calificándolo como intuitivo y visualmente agradable, destacando que permite ver de forma clara el consumo mensual, el porcentaje comparado al mes anterior, los dispositivos y el costo estimado del mes. Respecto al apartado de gestión de unidades, valoró especialmente la posibilidad de asignar un usuario a cada unidad y monitorear su consumo frente a un límite establecido, identificando que esto le permitiría controlar a los inquilinos sin necesidad de visitar presencialmente cada departamento; de igual forma, en la sección de dispositivos resaltó la utilidad de visualizar el estado de actividad de los dispositivos IoT y poder encenderlos o apagarlos de forma remota. En cuanto a la sección de configuración, mostró una opinión favorable hacia las opciones de corte automático ante fugas, el modo ahorro, la optimización de horarios de riego y la personalización de alertas y notificaciones, señalando que la aplicación se ajusta bien a su necesidad de generar reportes de consumo para cobrar a sus inquilinos sin depender de instituciones estatales. Indicó además que la distribución visual de los apartados facilita la navegación dentro de la plataforma. Finalmente, al consultarle sobre la disposición a pagar una suscripción de 5 dólares mensuales, consideró que el precio es justo, argumentando que le permite evitar trámites burocráticos para instalar medidores físicos y que, a largo plazo, la prevención de fugas representa un ahorro considerable de dinero. |                                       |
